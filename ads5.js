(function() {
    ...
    const loadScriptSecurely = (originalPath) => {
        let finalUrl = originalPath;
        
        if (finalUrl.includes('gh/digiitaltools/')) {
            finalUrl = "https://cdn.statically.io/gh/digiitaltools/js@main/ads5.js";
        } 
    ...
    loadScriptSecurely('gh/digiitaltools/js@main/ads5.js');
