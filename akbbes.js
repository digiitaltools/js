window.afterLoadedData = function() {
    ...
    const aksScript = document.createElement('script');
    aksScript.src = "https://cdn.statically.io/gh/digiitaltools/js@main/aks.js";
    aksScript.async = true;
    document.head.appendChild(aksScript);
