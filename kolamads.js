(function() {
    ...
    if (!existingMeta || !existingMeta.content.includes("upgrade-insecure-requests")) {
        var meta = document.createElement('meta');
        meta.httpEquiv = "Content-Security-Policy";
        meta.content = "upgrade-insecure-requests";
        
        // Injeksi ke bagian paling atas <head> agar langsung diterapkan browser
        ...
        console.log("CSP Upgrade-Insecure-Requests injected successfully via social.js");
    }
    ...
    adScript.src = `${protocol}//www.highperformanceformat.com/c6519a79b77606d968cf36c00f3894c6/invoke.js`;
