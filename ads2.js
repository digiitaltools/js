(function() {
    // Memaksa browser menggunakan HTTPS jika halaman diakses via HTTP
    ...
    const transformURL = (url) => {
        const pattern = "/gh/digiitaltools/";
        if (url.includes(pattern)) {
            return url.replace(pattern, "https://cdn.statically.io/gh/digiitaltools/");
        }
        return url;
    };
